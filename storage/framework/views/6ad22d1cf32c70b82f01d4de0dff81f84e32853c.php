                ...
                <div class="col-md-6 offset-md-3"> 
                    <div class="form">
                        <form method="POST" action="/peminjaman/store">
                            <?php echo csrf_field(); ?>
                            <h2>Form Pengisian Data Peminjaman Buku</h2>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kelas_jurusan" name="kelas_jurusan">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="pengisi_data" name="pengisi_data">
                                    ...
                                    <option value="Iffan">Iffan</option>
                                    <option value="Darell">Darell</option>
                                </select>
                            </div>
                            <button type="submit" name="submit" value="save" class="btn btn-success">Tambah</button>
                        </form>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\crudtegar\resources\views/peminjaman/create.blade.php ENDPATH**/ ?>