                    ...
                    <div>
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($pinjam as $p)
                                <tr>
                                    <th scope="row">{{$p->iteration}}</td>
                                    <td scope="row">{{$p->tanggal}}</td>
                                    <td scope="row">{{$p->nama_buku}}</td>
                                    <td scope="row">{{$p->nama_peminjam}}</td>
                                    <td scope="row">{{$p->kelas_jurusan}}</td>
                                    <td scope="row">{{$p->jenis_kelamin}}</td>
                                    <td scope="row">{{$p->pengisi_data}}</td>
                                    <td>
                                        <a href="/peminjaman/{{$p->id}}/edit"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i> Edit</button></a>
                                        <a href="/peminjaman/{{$p->id}}/delete"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i> Hapus</button></a>            
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
