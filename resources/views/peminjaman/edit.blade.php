                    ...
                    <div class="form">
                        <form method="POST" action="/peminjaman/{{$peminjaman->id}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_buku" name="nama_buku" value="{{$peminjaman->nama_buku}}">
                            </div>  
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kelas_jurusan" name="kelas_jurusan" value="{{$peminjaman->kelas_jurusan}}">
                            </div>
                            <div class="mb-3">
                                <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                                <select class="form-select" id="jenis_kelamin" name="jenis_kelamin">
                                    <option value="laki-laki" @if($peminjaman->jenis_kelamin == "laki-laki") selected @endif >Laki-laki</option>
                                    <option value="perempuan" @if($peminjaman->jenis_kelamin == "perempuan") selected @endif >Perempuan</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="pengisi_data" class="form-label">Pengisi Data</label>
                                <select class="form-select" id="pengisi_data" name="pengisi_data">
                                    <option value="Tegar" @if($peminjaman->pengisi_data == "Tegar") selected @endif>Tegar</option>
                                    <option value="Alfian" @if($peminjaman->pengisi_data == "Alfian") selected @endif>Alfian</option>
                                    <option value="Iffan" @if($peminjaman->pengisi_data == "Iffan") selected @endif>Iffan</option>
                                    <option value="Darell" @if($peminjaman->pengisi_data == "Darell") selected @endif>Darell</option>
                                </select>
                            </div>
